...
AD_PROMPT = """Generiere einen fiktiven Radiospot. Erfinde einen Sponsor, ein Produkt und eine Kernbotschaft, die zu einer {genre}-Station passen wuerde.

REGELN:
- Sponsor: ein erfundener Markenname (kein echter)
...
async def generate_random_ad(genre: str = "radio", audience: str = "alle") -> dict:
    ...
    if not result:
        return {"sponsor": "RADIO FM", "product": "Super Sound", "key_message": "Der beste Sound fuer deine Ohren"}
